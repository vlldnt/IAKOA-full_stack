...
import type { CompanyFormErrors } from '../hooks/useCreateCompanyForm';

// Icônes SVG inline — évite une dépendance externe pour des logos de marques
...
interface SocialNetworksFieldsProps {
  ...
  onChange: (key: keyof SocialNetworks, value: string) => void;
